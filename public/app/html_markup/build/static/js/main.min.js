!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="./static/js/",__webpack_require__(0)}([function(module,exports,__webpack_require__){(function($){"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}var _polyfills=__webpack_require__(2),_polyfills2=_interopRequireDefault(_polyfills);$(function(){_polyfills2.default.init(),$(".select").each(function(){var $self=$(this),$input=$self.find(".input");$input.on("click",function(e){e.stopPropagation(),$self.find(".select-dropdown").fadeIn(400)})}),$(document).on("click",function(){$(".select-dropdown").fadeOut(400),$(".nav-side").removeClass("is-active"),$(".content").removeClass("is-moved-content"),$(".header").removeClass("is-moved-header")}),$(".header-info__hamburger").on("click",function(e){e.stopPropagation(),$(".nav-side").toggleClass("is-active"),$(".content").toggleClass("is-moved-content"),$(".header").toggleClass("is-moved-header")}),$(".nav-side").on("click",function(e){e.stopPropagation()}),$(".user-edit-form").find(".icon-delete").on("click",function(){$(this).closest(".user-edit-form").hide(),$(".user-edit-form__add").show(),$(".user-edit__table").find("tbody tr").removeClass("is-active")}),$(".user-edit__table").find("tbody tr").on("click",function(){$(this).addClass("is-active").siblings().removeClass("is-active"),$(".user-edit-form__add").hide(),$(".user-edit-form__add").next().show()}),$(".group-edit-form").find(".icon-delete").on("click",function(){$(this).closest(".group-edit-form").hide(),$(".group-edit-form__add").show(),$(".group-edit__table").find("tbody tr").removeClass("is-active")}),$(".group-edit__table").find("tbody tr").on("click",function(){$(this).addClass("is-active").siblings().removeClass("is-active"),$(".group-edit-form__add").hide(),$(".group-edit-form__add").next().show()})})}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
