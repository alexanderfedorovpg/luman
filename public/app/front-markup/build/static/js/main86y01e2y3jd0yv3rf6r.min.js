!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="./static/js/",__webpack_require__(0)}([function(module,exports,__webpack_require__){(function($){"use strict";function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}var _polyfills=__webpack_require__(2),_polyfills2=_interopRequireDefault(_polyfills);$(function(){_polyfills2.default.init(),$(".social-links__share").on("click",function(){var $self=$(this);$(".social-links__list").removeClass("is-open"),$self.next().toggleClass("is-open")})}),$(document).ready(function(){var submitIcon=$(".search__ico"),inputBox=$(".search__input-text"),searchBox=$(".search__form"),isOpen=!1;submitIcon.on("click",function(){isOpen===!1?(searchBox.addClass("search-open"),inputBox.trigger("focus"),isOpen=!0):(searchBox.removeClass("search-open"),inputBox.trigger("focusout"),isOpen=!1)}),inputBox.on("click",function(){isOpen===!1?(searchBox.addClass("search-open"),inputBox.trigger("focus"),isOpen=!0):(searchBox.removeClass("search-open"),inputBox.trigger("focusout"),isOpen=!1)}),submitIcon.mouseup(function(){return!1}),searchBox.mouseup(function(){return!1}),$(document).mouseup(function(){isOpen===!0&&(submitIcon.css("display","block"),submitIcon.trigger("click"))})}),$(".search__input-text").on("keyup",function(){var $self=$(this),inputVal=$self.val();inputVal=$.trim(inputVal).length,0!==inputVal?$(".search__ico").css("display","none"):($self.val(""),$(".search__ico").css("display","block"))});var SimpleCollapse=function(){var self=this,collapse=$(".js-collap-wrap");collapse.each(function(){var $index=$(this).find(".js-collap-ln.is-active");$index.next().addClass("is-open").slideDown(400)}),collapse.on("click",".js-collap-ln",function(event){self.open($(this),event)}),self.open=function(elem,event){event.preventDefault();var parentCollapse=elem.closest(collapse);elem.hasClass("is-active")||(parentCollapse.find(".is-open").removeClass("is-open").slideUp(400),parentCollapse.find(".is-active").removeClass("is-active"),elem.parent().removeClass("is-active")),elem.parent().addClass("is-active"),elem.next().addClass("is-open").slideDown(400),elem.addClass("is-active")}};new SimpleCollapse}).call(exports,__webpack_require__(1))},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
