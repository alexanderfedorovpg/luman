var data = {random_news: {
    ...
    news_one: {
        ...
        img: '%=static=%img/content/random-news/queen.png',
    ...
    news_two: {
        ...
        img: '%=static=%img/content/random-news/random.png',
    ...
    news_three: {
        ...
        title_size: 'block-square__title_font_small',
        img: '%=static=%img/content/random-news/usa.png',
        time_add: '3 часа назад',
        alt: '',
        //time_update: 'Обновлено 15 минут назад',
        // time_keeping: '03:40'
    ...
    news_four: {
        ...
        title_size: 'block-square__title_font_small',
        img: '%=static=%img/content/random-news/putin.png',
        time_add: '3 часа назад',
        alt: '',
        //time_update: 'Обновлено 15 минут назад',
        // time_keeping: '03:40'
    ...
    more_news: {
        ...
        list: {
            1: {
                img: '%=static=%img/content/now/peskov.jpg',
