...
export const Clip = (props) => (
    <Svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" {...props}>
        <path d="M4.34 18a3.3 3.3 0 0 1-2.38-1.02 3.55 3.55 0 0 1 0-4.9L12.39 1.33a4.37 4.37 0 0 1 6.3 0C19.54 2.2 20 3.35 20 4.57a4.6 4.6 0 0 1-1.3 3.24l-8.22 8.45a.62.62 0 0 1-.9 0 .66.66 0 0 1 0-.92L17.8 6.9c.6-.62.94-1.44.94-2.32 0-.88-.34-1.7-.94-2.32a3.13 3.13 0 0 0-4.51 0L2.85 12.99a2.22 2.22 0 0 0 0 3.07c.8.82 2.19.82 2.99 0l7-7.2a1.07 1.07 0 0 0 0-1.49 1 1 0 0 0-1.44 0L6.61 12.3a.62.62 0 0 1-.89 0 .66.66 0 0 1 0-.92l4.79-4.92c.89-.91 2.34-.91 3.23 0a2.4 2.4 0 0 1 0 3.32l-7 7.21A3.31 3.31 0 0 1 4.33 18z" />
    </Svg>
);
